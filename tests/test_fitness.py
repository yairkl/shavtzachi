...
def test_skill_mismatch(db, setup_fitness_data):
    ...
    mismatch_score, conflicts, _ = evaluate_soldier_fitness(soldier, start, end, post, 0, {}, db)
...
def test_occupied_overlap(db, setup_fitness_data):
    ...
    overlap_score, conflicts, _ = evaluate_soldier_fitness(soldier, start, end, post, 0, {}, db)
...
def test_unavailable_conflict(db, setup_fitness_data):
    ...
    unavail_score, conflicts, _ = evaluate_soldier_fitness(soldier, start, end, post, 0, {}, db)
...
def test_cooldown_violation(db, setup_fitness_data):
    ...
    base_score, _, _ = evaluate_soldier_fitness(soldier, long_rest_start, long_rest_start + post.shift_length, post, 0, {}, db)
    ...
    cooldown_score, conflicts, last_shift = evaluate_soldier_fitness(soldier, start, end, post, 0, {}, db)
...
def test_history_score_and_rest_bonus(db, setup_fitness_data):
    ...
    score1, _, _ = evaluate_soldier_fitness(soldier, t1_start, t1_start + post.shift_length, post, 0, {}, db)
